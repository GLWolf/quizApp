...
function feedbackCorrect() {
    ...
    alt="${STORE[questionNumber].alt}"/></div><p><b>Nice job you got it correct!!!!</b></p><button type=button
...
function renderResults() {
    if(score >=9){
        ...
        chosen you!</h3><img src="img/pick.jpg" alt="ring"/><p>You are ready for traning report to Oa.</p><button
        class="restartButton">Restart Quiz</button></div`)
    } else {
